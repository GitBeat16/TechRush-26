    ...
    >
      ...
      >
        <Link
          ...
          onClick={() => play("nav")}
          className="relative block h-40 overflow-hidden rounded-clay shadow-clay-inset-sm sm:h-44 group-hover:brightness-[1.02] transition-all"
        >
          ...
          <motion.button
            ...
            aria-pressed={saved}
            className={[
              "absolute right-3 top-3 flex h-10 w-10 items-center justify-center rounded-full transition-colors duration-300 z-10",
              saved
        ...
        <div className="px-2 pb-1 pt-4">
          <div className="flex items-baseline justify-between gap-2">
            <Link
              href={`/destinations/${destination.id}`}
              onClick={() => play("nav")}
              className="hover:underline hover:text-clay-tangerine transition-colors"
            >
          ...
          <div className="mt-2.5 flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5">
              <Link
                href={`/destinations/${destination.id}`}
                onClick={() => play("nav")}
                className="rounded-full bg-clay-mint px-2.5 py-1 font-body text-[11px] font-bold text-clay-ink shadow-clay-xs transition-shadow hover:shadow-clay-sm flex items-center gap-1"
                title="Open interactive travel magazine flipbook"
              >
                <span>Magazine</span>
              </Link>
              <Link
