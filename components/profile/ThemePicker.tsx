...
export function ThemePicker() {
  const { theme, mode, setMode, explicit, saving, setTheme, clearOverride } = useTheme();
  ...
  return (
    <ClayCard tone="surface" radius="xl" depth="lg" className="p-5 sm:p-7">
      ...
      {/* Light / Dark Mode selector — ONLY visible for Original (clay) theme */}
      {theme === "clay" && (
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="font-body text-xs text-clay-ink-soft">
                Choose light or dark mode for the Original theme
              </p>
            </div>
          </div>
